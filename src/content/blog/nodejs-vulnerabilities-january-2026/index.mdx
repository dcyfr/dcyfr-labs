...
<TLDRSummary
  title="TL;DR: Node.js January 2026 Security Release - The 30-Second Brief"
  mostCommon={[
...
<KeyTakeaway variant="warning" title="HTTP/2 Server Crash Risk">
  A single malformed HTTP/2 HEADERS frame can **crash your entire Node.js process** if you don't have
  explicit error handlers on secure sockets. This affects **any HTTP/2 server** without `socket.on('error')` handlers. Add error handling NOW, then upgrade.
</KeyTakeaway>
