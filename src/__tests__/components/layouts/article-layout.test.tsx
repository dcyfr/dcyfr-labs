...
describe("ArticleLayout", () => {
  ...
  describe("Header", () => {
    ...
    it("renders header in header element", () => {
      const { container } = render(
        <ArticleLayout header={<div data-testid="header-content">Header</div>}>
          <div>Content</div>
        </ArticleLayout>
      );
  ...
  describe("Footer", () => {
    ...
    it("renders footer in footer element", () => {
      const { container } = render(
        <ArticleLayout footer={<div data-testid="footer-content">Footer</div>}>
          <div>Content</div>
        </ArticleLayout>
      );
    ...
    it("applies border-t class to footer", () => {
      const { container } = render(
        <ArticleLayout footer={<div>Footer</div>}>
          <div>Content</div>
        </ArticleLayout>
      );
  ...
  describe("Complex Scenarios", () => {
    ...
    it("renders with header only", () => {
      render(
        <ArticleLayout header={<div data-testid="header">Header Only</div>}>
          <div data-testid="content">Content</div>
        </ArticleLayout>
      );
    ...
    it("renders with footer only", () => {
      render(
        <ArticleLayout footer={<div data-testid="footer">Footer Only</div>}>
          <div data-testid="content">Content</div>
        </ArticleLayout>
      );
  ...
  describe("Accessibility", () => {
    ...
    it("uses semantic header element for header", () => {
      const { container } = render(
        <ArticleLayout header={<div>Header Content</div>}>
          <div>Content</div>
        </ArticleLayout>
      );
    ...
    it("uses semantic footer element for footer", () => {
      const { container } = render(
        <ArticleLayout footer={<div>Footer Content</div>}>
          <div>Content</div>
        </ArticleLayout>
      );
