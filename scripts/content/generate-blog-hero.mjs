...
function generateForPost(slug, options = {}) {
  ...
  try {
    ...
    // 3. Path validated via validateSlug() (prevents directory traversal)
    // 4. outputDir is constructed from constants + validated slug (not user input)
    //
    ...
    console.log(
      `   1. Review the generated image at: public/blog/images/${validatedSlug}/hero.svg`
    );
