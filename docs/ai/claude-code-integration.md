...
**Primary Instructions:** `.github/claude-instructions.md`
...
1. **Familiarize with Instructions**
   - Read `.github/claude-instructions.md`
   - Review Phase 4 tasks in `docs/operations/todo.md`
