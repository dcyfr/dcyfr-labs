...
const COMPONENT_RULES = {
  ...
  CollapsibleSection: {
    min: 0,
    max: 10,
    message: "Avoid excessive CollapsibleSection usage (max 10) - don't hide core content",
  },
  Alert: {
    min: 0,
    max: 3,
    message: 'Limit Alert components to 0-3 per post - reserve for critical information',
  },
  KeyTakeaway: {
    min: 0,
    max: 3,
...
function checkSectionShareCoverage(
  file: any,
  wordCount: number,
  sectionShareCount: number,
  strict: boolean
): void {
