...
Security researchers demonstrated command injection in Visual Studio Code's agentic AI workflows (<CVELink cve="CVE-2025-55319" />), enabling remote, unauthenticated attackers to execute commands on developers' machines through prompt injections hidden in README files or code comments.[^8]
...
1. **ASI01: Agent Goal Hijack**: Prompt injection redirects agent objectives (EchoLeak <CVELink cve="CVE-2025-32711" />)
...
5. **ASI05: Unexpected Code Execution (RCE)**: Code generation features exploited (<CVELink cve="CVE-2025-55319" />)
...
**CVE ID:** <CVELink cve="CVE-2025-32711" />  
...
**CVE ID:** <CVELink cve="CVE-2025-55319" />  
...
<CVEFootnote
  cve="CVE-2025-32711"
  description="EchoLeak - Microsoft 365 Copilot zero-click data exfiltration via prompt injection in emails"
  cvssScore={9.3}
  severity="CRITICAL"
/>
...
<CVEFootnote
  cve="CVE-2025-55319"
  description="Visual Studio Code agentic AI command injection enabling RCE via malicious repositories"
  cvssScore={8.8}
  severity="HIGH"
/>
