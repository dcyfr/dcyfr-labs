...
While this is a personal project, we aim to respond to:

- **Security vulnerabilities**: Within 48 hours
- **Bug reports**: Within 3-5 business days
- **Feature requests**: Within 7 business days
- **General questions**: As time permits

Response times are estimates and may vary based on complexity and availability.
...
Please follow our [Code of Conduct](./CODE_OF_CONDUCT.md) in all interactions. We're committed to providing a welcoming and inclusive environment for everyone.
