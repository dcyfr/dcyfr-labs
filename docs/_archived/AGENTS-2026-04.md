<!-- TLP:CLEAR -->
<!-- Historical snapshot: this is the pre-cleanup AGENTS.md, preserved for reference after the topline rewrite in the dcyfr-labs-cleanup change. See /AGENTS.md for the current version. -->
