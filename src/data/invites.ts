...
export const inviteCodes: InviteCode[] = [
  // Professional Networks
  {
    ...
    description:
      "Connect with me on LinkedIn for professional networking, industry insights, and career opportunities.",
  ...
  },
  {
    ...
    description:
      "Professional network for people in tech. Build your portfolio, connect with peers, and discover opportunities.",
    category: "professional-network",
    featured: true,
    addedAt: "2025-12-06",
  ...
  },
  {
    ...
    description:
      "Join me on Wellfound to explore startup opportunities, connect with founders, and grow your career in tech.",
    category: "professional-network",
    featured: false,
    addedAt: "2025-12-06",
  ...
  // Developer Communities
  {
    ...
    description:
      "Support open source development by sponsoring our work on GitHub.",
  ...
  // Learning Platforms
  {
    ...
    description:
      "AI-powered search engine that answers complex questions with sources. Use our referral link for a great experience.",
    category: "learning-platform",
    featured: true,
    addedAt: "2025-12-10",
    metrics: "Research with AI",
  },
  // Productivity Tools
  {
    id: "setapp",
  ...
  },
  {
    ...
    description:
      "Supercharge your productivity with Raycast. A blazingly fast launcher that lets you control tools, shortcuts, and workflows.",
    category: "productivity-tools",
    featured: false,
    addedAt: "2025-12-06",
  ...
  },
  {
    ...
    description:
      "Schedule a 1:1 meeting to discuss security, architecture, or career growth in tech.",
    category: "productivity-tools",
    featured: false,
    addedAt: "2025-12-06",
 ...
 */
export function getInviteCodesByCategory(
  category: InviteCode["category"]
): InviteCode[] {
 ...
 */
export const INVITE_CODE_CATEGORY_LABELS: Record<
  InviteCode["category"],
  string
> = {
