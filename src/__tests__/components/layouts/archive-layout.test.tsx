...
describe('ArchiveLayout', () => {
  ...
  describe('Item Count', () => {
    it('passes itemCount to PageHero', () => {
      render(
        <ArchiveLayout title="Blog Posts" description="All posts" itemCount={42}>
          <div>Content</div>
        </ArchiveLayout>
      );
  ...
  describe('Complex Scenarios', () => {
    ...
    it('renders archive with filters but no pagination', () => {
      render(
        <ArchiveLayout title="Projects" filters={<div data-testid="filters">Filters</div>}>
    ...
    it('renders archive with pagination but no filters', () => {
      render(
        <ArchiveLayout title="Posts" pagination={<div data-testid="pagination">Pagination</div>}>
          <div>Posts List</div>
        </ArchiveLayout>
      );
