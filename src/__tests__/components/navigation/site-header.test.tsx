...
describe('SiteHeader', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('renders AI link in desktop nav', () => {
      renderWithProviders(<SiteHeader />);
  ...
  describe('Styling and Layout', () => {
    it('applies fixed positioning to header', () => {
      renderWithProviders(<SiteHeader />);
      const header = screen.getByRole('banner');
    ...
    it('has backdrop blur effect always applied', () => {
      renderWithProviders(<SiteHeader />);
      const header = screen.getByRole('banner');

      // Backdrop blur and border are always present
  ...
  describe('Scroll Visibility Behavior', () => {
    ...
    it('hides when scrolling down past threshold', async () => {
      renderWithProviders(<SiteHeader />);
      const header = screen.getByRole('banner');
