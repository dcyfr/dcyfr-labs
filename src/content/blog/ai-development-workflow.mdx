...
```mermaid
%%{init: {'flowchart': {'htmlLabels': true, 'useMaxWidth': true, 'nodeSpacing': 150, 'rankSpacing': 150}}}%%
graph LR
    A["<b>AI Client</b><br/>Claude, Copilot"] 
    B["<b>MCP Server</b><br/>GitHub, Sentry,<br/>Database"]
    C["<b>Data Source</b><br/>GitHub, Sentry,<br/>Postgres"]
