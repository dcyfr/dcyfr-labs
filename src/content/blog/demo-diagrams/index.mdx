...
summary: "Explore interactive, accessible diagrams built with ReactFlow for visualizing architecture, workflows, and decision trees."
publishedAt: "2025-11-09T00:00:00Z"
category: "Demo"
tags: ["Diagrams", "ReactFlow", "Interactive", "Visualization", "Demo"]
draft: true
series:
  name: "Features"
  order: 1
...
After migrating away from Mermaid, we've built a set of interactive diagrams using [ReactFlow](https://xyflow.com/) that provide better performance, accessibility, and customization. These diagrams are fully interactive—you can pan, zoom, and explore them freely.
...
<MCPArchitecture height={300} caption="The three-tier MCP architecture: AI clients communicate with MCP servers through the protocol, which then access data sources via APIs." />
...
<AuthenticationFlow height={500} caption="A user authentication flow showing the decision point where valid credentials lead to the dashboard while invalid credentials redirect to the login page." />
...
<PipelineFlow height={600} caption="The MDX processing pipeline transforms raw markdown through remark parsing, rehype transformation, syntax highlighting, React compilation, and finally browser rendering." />
...
<CVEDecisionTree height={400} caption="A decision tree for assessing CVE-2025-55182 impact: users determine vulnerability by checking if they use React Server Components and their React version." />
