...
describe('useBookmarks', () => {
  beforeEach(() => {
    ...
    mockBookmarksModule.filterBookmarkedActivities.mockImplementation(
      (activities: ActivityItem[], collection: any) => {
  ...
  describe('Mutation operations', () => {
    ...
    it('should add bookmark', () => {
      ...
      expect(mockBookmarksModule.addBookmark).toHaveBeenCalledWith('activity-2', mockCollection, {
        notes: 'New note',
      });
    });
  ...
  describe('Filtering operations', () => {
    it('should filter activities to bookmarked only', () => {
      ...
      result.current.filterActivities(mockActivities);
    ...
    it('should search bookmarks', () => {
      ...
      expect(mockBookmarksModule.searchBookmarks).toHaveBeenCalledWith(
        'test query',
        mockCollection
      );
    ...
    it('should filter by tag', () => {
      ...
      expect(mockBookmarksModule.filterBookmarksByTag).toHaveBeenCalledWith(
        'important',
        mockCollection
      );
