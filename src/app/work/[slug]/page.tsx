...
import { SITE_URL, SITE_TITLE_PLAIN, AUTHOR_NAME, getOgImageUrl } from '@/lib/site-config';
import { CONTAINER_WIDTHS, CONTAINER_PADDING, PAGE_LAYOUT } from '@/lib/design-tokens';
