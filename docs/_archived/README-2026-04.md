<!-- TLP:CLEAR -->
<!-- Historical snapshot: pre-cleanup README.md, preserved for reference after the topline rewrite in dcyfr-labs-cleanup. See /README.md for the current version. -->
