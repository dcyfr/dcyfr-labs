...
| QUICK_REFERENCE.md | Quick status overview | 5 min | Current |
| SECURITY_ANALYSIS_SUMMARY.md | High-level findings | 15 min | Current |
| IMPLEMENTATION-SUMMARY.md | Current implementation status | 15 min | Current |
| security-status.md | Current status snapshot | 10 min | Current |

### API Security

| File | Purpose | Read Time | Status |
|------|---------|-----------|--------|
| api-security-audit-2025-12-11.md | Latest API security audit | 20 min | Current |
| api-security-audit.md | Previous audit (reference) | 20 min | Archive |
| api-security-lessons-learned.md | Key learnings from API work | 15 min | Current |
| api-security-lockdown-lessons-learned.md | Security hardening lessons | 15 min | Current |
| [inngest-webhook-security.md](./inngest-webhook-security.md) | Inngest integration security | 10 min | Current |
| inngest-auth-failures-fix.md | Inngest auth issues & fixes | 10 min | Archive |
| inngest-auth-failures-fix.md | Production API security summary | 10 min | Current |
...
| bot-detection-quick-ref.md | Bot detection quick reference | 5 min | Current |
| [botid-implementation.md](./botid-implementation.md) | BotID implementation details | 15 min | Current |
| botid-re-enablement-plan.md | Re-enabling BotID protection | 10 min | Current |
| [anti-spam-implementation.md](./anti-spam-implementation.md) | Anti-spam system | 20 min | Current |
| anti-spam-summary.md | Anti-spam overview | 10 min | Current |
| anti-spam-quick-ref.md | Anti-spam quick reference | 5 min | Current |
...
| File | Purpose | Read Time | Status |
|------|---------|-----------|--------|
| codeql-findings-resolved.md | CodeQL vulnerability fixes | 15 min | Current |
| codeql-fixes-summary.md | CodeQL fixes overview | 5 min | Current |
| code-scanning-alert-dismissals.md | Code scanning dismissals log | 10 min | Archive |
| SECURITY_FIX_CWE918_SSRF.md | SSRF vulnerability fix | 10 min | Current |
...
| pi-pii-expansion-summary.md | PII policy expansion | 10 min | Current |
| environment-variable-audit.md | Env var security audit | 15 min | Current |

### Infrastructure & Deployment

| File | Purpose | Read Time | Status |
|------|---------|-----------|--------|
| REDIS_CONNECTIVITY_FIX.md | Redis security fix | 10 min | Archive |
| redis-import-fix.md | Redis import security | 10 min | Archive |
| safari-tls-fix.md | Safari TLS compatibility | 15 min | Current |
| safari-tls-quick-reference.md | TLS fix quick ref | 5 min | Current |
| vercel-protection-bypass.md | Vercel security bypass | 10 min | Archive |
| github-activity-migration.md | GitHub migration security | 10 min | Archive |

### Monitoring & Incident Response

| File | Purpose | Read Time | Status |
|------|---------|-----------|--------|
| sentry-integration-complete.md | Sentry setup complete | 10 min | Current |
| [sentry-alerts-setup.md](./sentry-alerts-setup.md) | Sentry alerts configuration | 15 min | Current |
| sentry-manual-alert-setup.md | Manual alert setup | 15 min | Archive |
| monitoring-quick-reference.md | Monitoring quick ref | 5 min | Current |
...
| red-team-engagement-plan.md | Red team findings & recommendations | 30 min | Current |
| SECURITY_ANALYSIS_TEST_ENDPOINTS.md | Security test endpoints | 20 min | Current |
...
| File | Purpose | Read Time | Status |
|------|---------|-----------|--------|
| ASI-AUDIT.md | Application Security Inc. audit | 45 min | Archive |
| security-audit-summary-2025-12-11.md | Audit summary | 20 min | Current |
| security-analysis-complete.md | Analysis completion status | 10 min | Archive |
| FINDINGS_AND_ACTION_ITEMS.md | Actionable findings | 30 min | Current |
| security-findings-resolution.md | Finding resolution status | 20 min | Current |
...
| captcha-evaluation.md | CAPTCHA system evaluation | 15 min | Current |
| completion-status-2025-12-12.md | Completion status snapshot | 10 min | Archive |
| optional-enhancements-2025-12-12.md | Optional improvements | 15 min | Archive |
...
2. Review red-team-engagement-plan.md
3. Check IMPLEMENTATION-SUMMARY.md for status
4. Use monitoring-quick-reference.md for ongoing monitoring

**Developers:**
1. Start with QUICK_REFERENCE.md
2. Review SECURITY_ANALYSIS_SUMMARY.md
3. Check specific area docs (API, Bot Detection, etc.)
4. Reference security-fixes-2025-12-11.md for recent fixes
...
**Project Managers:**
1. Start with SECURITY_ANALYSIS_SUMMARY.md
2. Review FINDINGS_AND_ACTION_ITEMS.md
3. Check security-findings-resolution.md for progress
4. Use completion-status-2025-12-12.md for status

### By Task

**Need to fix security issues:**
→ security-fixes-2025-12-11.md
...
→ [axiom-security-queries.md](./axiom-security-queries.md) + monitoring-quick-reference.md
