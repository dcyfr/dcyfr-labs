...
## OWASP Agentic Top 10 Breakdown
...
<RoleBasedCTA
  ...
  description="Download the complete OWASP Agentic AI security framework and threat models"
  buttonText="Get Security Framework"
