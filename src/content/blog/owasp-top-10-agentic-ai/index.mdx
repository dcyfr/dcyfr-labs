...
<TLDRSummary
  ...
  mostCommon={[
    ...
    "ASI03 Memory Poisoning - Long-term context corruption influencing future decisions",
  ]}
  mostDangerous={[
...
<KeyTakeaway variant="tip" title="Practical First Steps">
  Start with observability: comprehensive logging of agent actions, tool
  invocations, and goal changes. You can't secure what you can't see.
</KeyTakeaway>
