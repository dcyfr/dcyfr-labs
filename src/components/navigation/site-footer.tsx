...
export function SiteFooter() {
  return (
    <footer className="hidden md:block border-t mt-16 site-footer">
      <div className={cn("mx-auto", CONTAINER_WIDTHS.archive, "px-4", "sm:px-6", "md:px-8", "h-16", "flex", "flex-col", "md:flex-row", "items-center", "justify-between", "gap-4", "md:gap-0", "text-sm", "py-4", "md:py-0")}>
