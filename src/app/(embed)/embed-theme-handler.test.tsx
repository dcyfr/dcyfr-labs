...
describe('EmbedThemeHandler Security', () => {
  ...
  describe('Origin Verification (Security)', () => {
    ...
    it('should accept messages from dcyfr.ai', async () => {
      render(<EmbedThemeHandler />);
    ...
    it('should accept messages from www.dcyfr.ai', async () => {
      render(<EmbedThemeHandler />);
    ...
    it('should accept messages from preview deployment (dcyfr-preview.vercel.app)', async () => {
      render(<EmbedThemeHandler />);

      const validEvent = new MessageEvent('message', {
        origin: 'https://dcyfr-preview.vercel.app',
        data: { type: 'setTheme', theme: 'dark' },
      });
