...
const pageDescription = "Learn more about our team, mission, and the passion that drives us to secure emerging tech.";
  ...
  return (
    <PageLayout>
      ...
      >
        ...
        {/* About Drew */}
        <Section id="about-drew" className={PAGE_LAYOUT.hero.container}>
          <div
            className={cn(
              "flex flex-col md:flex-row items-center md:items-start gap-4",
              SPACING.content
          ...
          >
            ...
            <div className="flex-1 space-y-4">
              <h1 className={cn(TYPOGRAPHY.h1.hero, "font-serif")}>
                <span className="flex items-center gap-2 ">About Drew</span>
              </h1>
        ...
        {/* About Drew - What Drives Me */}
        <Section id="what-drives-me" className={PAGE_LAYOUT.section.container}>
          <ScrollReveal animation="fade-up" delay={0}>
            <div className={SPACING.content}>
              <h2 className={TYPOGRAPHY.h2.standard}>What Drives Me</h2>
              <div className="space-y-3 text-muted-foreground">
                <p>
                  My passion for cybersecurity stems from a deep-seated
                  curiosity about technology and a commitment to making the
                  digital world a safer and more secure place. I thrive on
                  solving complex problems, staying ahead of emerging threats,
                ...
                <p>
                  ...
                  security-first culture, and collaborating across teams to
                  build resilient systems. I&apos;m dedicated to empowering
                  organizations to protect their assets while enabling
        ...
        {/* About Drew - Professional Background */}
        <Section
          ...
          <ScrollReveal animation="fade-up" delay={50}>
            <div className={SPACING.content}>
              ...
              <div className="mb-12">
                <AboutStats
                  blogCount={
                    posts.filter((p) => !p.archived && !p.draft).length
                  }
        ...
        {/* About Drew - GitHub Activity */}
        <Section id="github-activity" className={PAGE_LAYOUT.section.container}>
