...
describe('Resume Data', () => {
  ...
  describe('Skills Validation', () => {
    ...
    it('has critical skills category', () => {
      const critical = resume.skills.find((s) => s.category.toLowerCase().includes('critical'));
      expect(critical).toBeDefined();
    });

    it('has security knowledge category', () => {
      const security = resume.skills.find((s) => s.category.toLowerCase().includes('security'));
      expect(security).toBeDefined();
    });

    it('has technologies category', () => {
      const tech = resume.skills.find((s) => s.category.toLowerCase().includes('technolog'));
