...
<SeriesBackgroundNote
  ...
  context="where I built the foundation for what would become a comprehensive developer platform. This series documents the security hardening, performance optimization, and production features that transformed a simple portfolio into an enterprise-ready system"
/>
  ...
  sections={[
    {
      ...
      points: [
        'Implemented Content Security Policy (CSP) via Next.js middleware for XSS and clickjacking protection',
        'Built a zero-dependency, in-memory rate limiter for API endpoints to prevent abuse',
      ],
    },
    {
      title: 'Performance Optimization',
      points: [
        'Improved INP from 664ms to under 200ms by disabling Next.js hover prefetching and optimizing CSS',
        'Integrated live GitHub contributions heatmap with client-side caching',
      ],
    },
    {
      title: 'Developer Experience',
      points: [
        'Created AI contributor guide for consistent code quality with GitHub Copilot and other assistants',
      ],
    },
  ]}
