...
image:
  ...
  alt: 'A single stream of light splits into parallel streams symbolizing asynchronous event processing.'
...
> **Series Background:** This is Part 3 of the Portfolio series, following [Shipping a Developer Portfolio](/blog/shipping-developer-portfolio) and [Hardening a Developer Portfolio](/blog/hardening-developer-portfolio). Here we explore how event-driven architecture transforms user experience and system reliability.
...
<GlossaryTooltip term="Event-Driven Architecture" definition="A software design pattern where components communicate by publishing and consuming events asynchronously, enabling loosely coupled, scalable systems">Event-driven architecture</GlossaryTooltip> separates two concerns:
...
<SectionShare sectionId="event-driven-explained" sectionTitle="Event-Driven Architecture Explained" />
...
<SectionShare sectionId="scheduled-tasks-github-contributions" sectionTitle="Scheduled Tasks: GitHub Contributions" />
...
After discovering [CVE-2025-55182](/blog/cve-2025-55182-react2shell) in December 2025 (with a 13-hour detection gap), I added automated security monitoring.
