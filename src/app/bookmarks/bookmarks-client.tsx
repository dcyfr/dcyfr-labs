...
export function BookmarksClient({ posts, activities }: BookmarksClientProps) {
  ...
  const totalBookmarked = React.useMemo(() => {
    ...
    const nonBlogActivities = bookmarkedActivities.filter(a =>
  ...
  const nonBlogBookmarkedActivities = React.useMemo(() => {
    if (!isMounted) return [];
    return bookmarkedActivities.filter(a =>
      !(a.source === "blog" && a.href.startsWith("/blog/"))
    );
          ...
          <DialogHeader>
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 space-y-2">
                ...
                <DialogDescription>
                  This will remove all {totalBookmarked} bookmarked {totalBookmarked === 1 ? "item" : "items"}. This action cannot be undone.
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>
