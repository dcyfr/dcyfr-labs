...
describe('HorizontalFilterChips', () => {
  ...
  describe('Rendering', () => {
    ...
    it('limits category display to 6 items', () => {
      const largeCategoryList = ['cat1', 'cat2', 'cat3', 'cat4', 'cat5', 'cat6', 'cat7', 'cat8'];
  ...
  describe('Selected State', () => {
    it('shows selected state for active category', () => {
      render(<HorizontalFilterChips {...defaultProps} selectedCategory="security" />);
  ...
  describe('Edge Cases', () => {
    it('handles empty category list', () => {
      render(<HorizontalFilterChips {...defaultProps} categoryList={[]} categoryDisplayMap={{}} />);
