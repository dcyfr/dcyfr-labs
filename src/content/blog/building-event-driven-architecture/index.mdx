  ...
  sections={[
    {
      title: 'Core Pattern',
      items: [
        'Separate acknowledgment from processing for instant API responses (< 100ms)',
        'Use Inngest step functions for durable execution with automatic retries',
        'Pre-populate caches with scheduled tasks instead of fetching on demand',
      ],
    },
    {
      title: 'Production Results',
      items: [
        'Contact form response dropped from 1-2 seconds to under 100ms',
        'Email delivery reliability improved to 99.9% with retry policies',
        'Automated security advisory monitoring runs 3x daily',
      ],
    },
    {
      title: 'Implementation',
      items: [
        'Zero infrastructure: serverless with Vercel-native Inngest integration',
        '8 background functions running in production (contact, analytics, security)',
        'Step-based checkpoints prevent redundant work on retries',
      ],
    },
  ]}
/>
...
<KeyTakeaway variant="insight" title="The Core Insight">
...
<RoleBasedCTA
  role="executive"
  title="For Leaders"
  description="Event-driven architecture transforms API reliability and user experience. This post demonstrates real production results: 10x faster response times, 99.9% delivery reliability, and automated security monitoring—all without managing queue infrastructure."
  buttonText="Contact Us"
  buttonHref="/contact?role=executive&topic=event-driven-architecture"
/>
...
<RoleBasedCTA
  ...
  description="Implement event-driven architecture in any Next.js project with Inngest. Use step functions for durable execution, automatic retries with exponential backoff, and a local dev UI for debugging. Zero infrastructure required."
  buttonText="View Implementation"
  buttonHref="#implementation-contact-form"
/>
...
<KeyTakeaway variant="tip" title="Validate Then Queue">
...
<KeyTakeaway variant="insight" title="Steps Are Checkpoints">
...
<RoleBasedCTA
  ...
  description="Background jobs are a security surface. This post covers automated CVE monitoring (3x daily GHSA checks), input validation in async pipelines, and how a 13-hour detection gap led to building automated security advisory monitoring."
  buttonText="Security Patterns"
  buttonHref="#the-security-monitor"
/>
...
<KeyTakeaway variant="warning" title="Don't Over-Engineer">
