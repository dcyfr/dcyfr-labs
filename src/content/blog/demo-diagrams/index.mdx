...
<SectionShare
  ...
  sectionTitle="Interactive Diagrams with ReactFlow"
/>
...
<SectionShare
  sectionId="diagram-presets"
  sectionTitle="Available Diagram Presets"
/>
...
<CVEDecisionTree
  height={400}
  caption="A decision tree for assessing CVE-2025-55182 impact: users determine vulnerability by checking if they use React Server Components and their React version."
/>
