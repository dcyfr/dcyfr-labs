 ...
 * 
 * Last synced: 2025-11-08 (Archive update - removed highlights)
 * 
  ...
  return (
    <Card className="flex h-full flex-col overflow-hidden relative">
      ...
      <CardFooter className="mt-auto flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-3 relative z-10 px-4 sm:px-6 py-3 sm:py-4">
        <Skeleton className="h-10 w-full sm:w-32 rounded-md" /> {/* View Details */}
        <Skeleton className="h-10 w-full sm:w-20 rounded-md" /> {/* External link */}
      </CardFooter>
    </Card>
  );
}
