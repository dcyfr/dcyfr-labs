      ...
      <div className={cn(SPACING.subsection)}>
        <div>
          ...
          <p className="text-lg text-muted-foreground mt-4">
            Click through these interactive flowcharts to quickly determine which architectural
            patterns to use. Each tree provides copy-paste code examples at the end.
          </p>
        </div>
