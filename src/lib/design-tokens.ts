...
// ============================================================================
// MODERN WEB APP ENHANCEMENTS (Vercel-inspired)
// ============================================================================

/**
 * Gradient utility classes for modern, depth-rich designs
 * Inspired by Vercel's visual language with cybersecurity accent
 *
 * These are Tailwind class strings (not CSS values like GRADIENTS above).
 * Use these for applying gradients directly to elements.
 *
 * @example
 * ```tsx
 * // Hero section gradient background
 * <div className="relative">
 *   <div className={GRADIENT_CLASSES.heroOverlay} />
 *   <div className="relative z-10">{content}</div>
 * </div>
 *
 * // Subtle card depth
 * <Card className={GRADIENT_CLASSES.cardSubtle}>...</Card>
 * ```
 */
export const GRADIENT_CLASSES = {
  /** Hero section overlay - Blue to purple gradient (cybersecurity theme) */
  heroOverlay: "absolute inset-0 bg-gradient-to-br from-blue-500 via-purple-500 to-blue-600 opacity-10 dark:opacity-5 pointer-events-none",

  /** Accent gradient - Cyan to purple (primary actions, highlights) */
  accent: "bg-gradient-to-r from-cyan-500 to-purple-600",

  /** Subtle card gradient - Adds depth without overwhelming content */
  cardSubtle: "bg-gradient-to-b from-transparent to-muted/30",

  /** Text gradient - For attention-grabbing headlines */
  text: "bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600 bg-clip-text text-transparent dark:from-blue-400 dark:via-purple-400 dark:to-cyan-400",

  /** Border gradient - Glowing border effect */
  border: "bg-gradient-to-r from-blue-500/50 via-purple-500/50 to-cyan-500/50",

  /** Success gradient - Green glow for positive states */
  success: "bg-gradient-to-r from-green-500 to-emerald-600",

  /** Warning gradient - Amber to orange for alerts */
  warning: "bg-gradient-to-r from-amber-500 to-orange-600",

  /** Danger gradient - Red glow for critical items */
  danger: "bg-gradient-to-r from-red-500 to-rose-600",

  /** Mesh background - Subtle grid pattern overlay */
  mesh: "bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-100 via-transparent to-transparent dark:from-blue-950/20",
} as const;

/**
 * Glassmorphism effects - Modern frosted glass aesthetic
 *
 * Based on iOS/macOS glass materials with proper backdrop blur support.
 * Requires backdrop-blur utility in Tailwind config.
 *
 * @example
 * ```tsx
 ...
 */
export const GLASS = {
  /** Light glass - For light mode UI elements */
  light: "bg-white/70 backdrop-blur-md border border-white/20",

  /** Dark glass - For dark mode UI elements */
  dark: "bg-slate-900/70 backdrop-blur-md border border-slate-700/50",

  /** Adaptive glass - Adjusts based on theme */
  adaptive: "bg-white/70 dark:bg-slate-900/70 backdrop-blur-md border border-white/20 dark:border-slate-700/50",

  /** Navigation glass - Sticky headers with blur */
  nav: "bg-white/80 dark:bg-slate-900/80 backdrop-blur-lg border-b border-border/50 sticky top-0 z-50",

  /** Card glass - Elevated cards with frosted effect */
  card: "bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/30 dark:border-slate-700/40 shadow-lg",

  /** Modal glass - Full-screen overlays */
  modal: "bg-black/40 backdrop-blur-sm",

  /** Tooltip glass - Small floating elements */
  tooltip: "bg-slate-800/90 dark:bg-slate-200/90 backdrop-blur-sm text-white dark:text-slate-900",

  /** Sidebar glass - Side navigation panels */
  sidebar: "bg-white/95 dark:bg-slate-900/95 backdrop-blur-2xl border-r border-border/50",
} as const;

/**
 * Interactive state patterns - Micro-interactions and feedback
 *
 * Enhanced hover, active, and focus states for modern UX.
 * Combines transforms, shadows, and transitions.
 *
 * @example
 * ```tsx
 * // Interactive card
 * <Card className={INTERACTIVE.cardHover}>...</Card>
 *
 * // Button press feedback
 * <Button className={INTERACTIVE.press}>...</Button>
 *
 * // Focus ring for accessibility
 * <input className={INTERACTIVE.focus} />
 * ```
 */
export const INTERACTIVE = {
  /** Card hover - Lift and glow effect */
  cardHover: "transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:shadow-blue-500/10 dark:hover:shadow-blue-500/20",

  /** Button hover - Subtle lift with scale */
  buttonHover: "transition-all duration-200 hover:scale-[1.02] hover:shadow-md active:scale-[0.98]",

  /** Press feedback - Scale down on click */
  press: "transition-transform duration-150 active:scale-95",

  /** Focus ring - Enhanced accessibility outline */
  focus: "focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900",

  /** Glow on hover - Adds subtle glow effect */
  glow: "transition-all duration-300 hover:shadow-[0_0_20px_rgba(59,130,246,0.3)] dark:hover:shadow-[0_0_20px_rgba(59,130,246,0.5)]",

  /** Link hover - Underline with gradient */
  link: "relative after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 after:bg-gradient-to-r after:from-blue-500 after:to-purple-600 after:transition-all after:duration-300 hover:after:w-full",

  /** Magnetic effect - Subtle movement toward cursor */
  magnetic: "transition-transform duration-300 hover:scale-105",
 ...
 *
 * Card flips, parallax scrolling, and layered depth effects.
 * Use sparingly for hero sections and featured content.
 *
 * @example
 * ```tsx
 * // Flippable card
 * <div className={DEPTH.cardFlip}>
 *   <div className={DEPTH.cardFront}>Front</div>
 *   <div className={DEPTH.cardBack}>Back</div>
 * </div>
 *
 * // Parallax container
 * <div className={DEPTH.parallax}>...</div>
 * ```
 */
export const DEPTH = {
  /** Perspective container - Required for 3D children */
  perspective: "perspective-1000",

  /** Card flip - Rotate on Y-axis */
  cardFlip: "transition-transform duration-700 transform-style-3d",

  /** Card front face */
  cardFront: "absolute inset-0 backface-hidden",

  /** Card back face */
  cardBack: "absolute inset-0 backface-hidden rotate-y-180",

  /** Parallax layer - Slower scroll for depth */
  parallax: "transition-transform duration-200 ease-out",

  /** Elevated layer - Slight lift with shadow */
  elevated: "transform translate-z-10 shadow-2xl",

  /** Tilt on hover - Subtle 3D tilt effect */
  tilt: "transition-transform duration-300 hover:rotate-x-2 hover:rotate-y-2",
} as const;

/**
 * Performance-optimized animations - GPU-accelerated transforms
 *
 * Uses will-change sparingly and transform3d for hardware acceleration.
 * Prefer these over width/height/margin animations.
 *
 * @example
 * ```tsx
 * // Fade in animation
 * <div className={PERF_ANIMATIONS.fadeIn}>...</div>
 *
 * // Slide up reveal
 * <div className={PERF_ANIMATIONS.slideUp}>...</div>
 * ```
 */
export const PERF_ANIMATIONS = {
  ...
  /** Slide up - Transform Y from bottom */
  slideUp: "animate-in slide-in-from-bottom-4 duration-500",

  /** Slide down - Transform Y from top */
  slideDown: "animate-in slide-in-from-top-4 duration-500",

  /** Slide left - Transform X from right */
  slideLeft: "animate-in slide-in-from-right-4 duration-500",

  /** Slide right - Transform X from left */
  slideRight: "animate-in slide-in-from-left-4 duration-500",

  /** Scale in - Zoom from small to normal */
  scaleIn: "animate-in zoom-in-95 duration-300",

  /** Scale out - Zoom from normal to small */
