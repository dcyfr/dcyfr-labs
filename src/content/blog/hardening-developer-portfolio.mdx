---
title: "Hardening a Developer Portfolio: Security, Performance & Production Readiness"
...
image:
  ...
  alt: "Security and performance symbols on a dark technical background"
  caption: "Production hardening: from working code to production-ready application"
  width: 1200
  height: 630
---

> **Series Background:** This is a follow-up to [Shipping a Developer Portfolio: Next.js, Tailwind v4 & shadcn/ui](/blog/shipping-tiny-portfolio), where I built a minimal portfolio with Next.js 15, TypeScript, and Tailwind v4 in a weekend. This series documents the production-hardening work I did after launch.
