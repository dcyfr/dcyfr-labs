...
const AnalyticsCharts = dynamic(
  () =>
    import('@/components/analytics/analytics-charts').then((mod) => ({
...
import { PublicationCohort, PerformanceTierFilter, TagFilterMode } from '@/types/analytics';
...
export default function AnalyticsDashboard({
  ...
  return (
    ...
    >
                          ...
                          <TooltipContent side="left" className="text-xs">
                            <div className="space-y-1">
                              <p className="font-semibold">
                                {getBenchmark(post.views, filteredSummary.averageViews)}
                              </p>
                              <p className="text-muted-foreground">
                                Site average: {filteredSummary.averageViews.toLocaleString()}
                              </p>
      ...
      <SocialMetrics posts={sortedPosts} defaultCollapsed={false} />
      ...
      <Card>
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className={TYPOGRAPHY.label.standard}>Conversion Metrics</CardTitle>
            ...
            >
              ...
              <ChevronDown
                className={cn('h-4 w-4 transition-transform', showConversion && 'rotate-180')}
              />
            </Button>
          </div>
        </CardHeader>
      ...
      <Card>
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className={TYPOGRAPHY.label.standard}>Performance Insights</CardTitle>
              <CardDescription className="text-sm">
            ...
            >
              ...
              <ChevronDown
                className={cn('h-4 w-4 transition-transform', showPerformance && 'rotate-180')}
              />
            </Button>
          </div>
        </CardHeader>
